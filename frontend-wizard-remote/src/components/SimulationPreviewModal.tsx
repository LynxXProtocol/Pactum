...
import type { SimulationPreview } from '@pactum/soroban-client';
      ...
      >
        ...
        >
          ...
          <p style={{ margin: '6px 0 0 0', fontSize: '13px', color: 'rgba(255,255,255,0.8)' }}>
            {isLoading
              ? 'Evaluating contract execution on Soroban RPC...'
              : isSuccess
                ? 'Preflight simulation succeeded. Review estimated costs below.'
                : 'Simulation encountered an error. The transaction cannot be executed.'}
          </p>
        </div>
        ...
        <div style={{ padding: '20px 24px 24px' }}>
          {isLoading && (
            ...
            >
              <Loader2 size={20} style={{ animation: 'spin 1s linear infinite' }} /> Simulating
              transaction...
            </div>
          )}
